...
--   6. degenaration-tp-sell-basis.sql           take-profits sell a share of the ORIGINAL fill
--
...
-- releases its claim to retry, and a stop-loss closes the position for good. Migration 6
-- is verified the same way: the shipped 50%/25% ladder on a 1000-token fill sells 500 then
-- 250 (it sold 500 then 125 before), a ladder summing above 100% is capped at what is
-- still held rather than over-selling, and a pre-existing position with no recorded
-- opening fill falls back to its current balance.
-- ============================================================
...
-- ============================================================
-- degenaration-tp-sell-basis.sql
-- ============================================================
