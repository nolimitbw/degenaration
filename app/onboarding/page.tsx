        ...
        <div className="rounded-lg border border-edge bg-panel p-6">
          ...
          {step === 0 && (
            <div className="mt-4 space-y-4 text-sm text-dim">
              ...
              {!authenticated && <button onClick={login} disabled={!ready} className="inline-flex min-h-10 items-center gap-2 rounded-md border border-edge px-4 text-xs font-bold transition hover:border-gold-400 disabled:opacity-50"><LogIn size={15} /> Sign in to continue</button>}
