  ...
  return (
    <main id="main-content" tabIndex={-1} className="grid-bg flex min-h-screen flex-col items-center justify-center gap-4 px-5 text-center">
      ...
      <div className="mt-2 flex gap-3">
        <button onClick={reset} className="rounded-md bg-gold-400 px-6 py-3 font-bold text-white shadow-gold transition hover:brightness-110">
          Try again
        </button>
        <Link href="/" className="rounded-md border border-edge bg-panel px-6 py-3 font-bold text-ink transition hover:border-gold-400">
          Home
        </Link>
      </div>
    </main>
