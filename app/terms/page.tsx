  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-dim">
        ...
        <p><b className="text-ink">Non-custodial.</b> You retain sole control of your wallet and keys. The platform executes trades only within the trade-only permission and limits you grant, and can never withdraw your funds.</p>
        <p><b className="text-ink">Fees.</b> A 2% fee is applied on-chain to each trade. You are responsible for network fees and taxes in your jurisdiction.</p>
