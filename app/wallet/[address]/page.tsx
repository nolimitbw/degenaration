  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-6xl">
        <div className="flex items-center gap-3"><WalletCards aria-hidden="true" className="text-gold-400" /><div><h1 className="text-2xl font-bold">Public wallet P&amp;L</h1><p className="mt-1 break-all font-mono text-[11px] text-dim">{address}</p></div></div>
