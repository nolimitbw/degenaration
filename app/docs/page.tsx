...
const FAQ = [
  ...
  { q: "How does automation work?", a: "You set a per-trade limit, a source cap, and a daily wallet cap. Every automated entry is checked against those limits before it can run. Bots do not place trades on their own yet; the execution worker is not running." },
  ...
  { q: "Which network does this use?", a: "Manual wallet-signed swaps use Solana Mainnet and real funds. Trades are irreversible. Bots do not place trades on their own yet." },
