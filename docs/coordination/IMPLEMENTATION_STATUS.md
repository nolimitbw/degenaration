...
| 3 | Self-service user principal withdrawal | §12 | PARTIAL | `47dec45`; endpoint + rules module + real modal; 11 withdrawal tests. `app_user_withdrawable_state` RPC **applied to the live database**. **Not exercised against a funded wallet** |
