...
| 1 | Single-source 200 bps fee, integer math | §13.1 | NOT STARTED | F-1 |
| 2 | Creator 70/20 bps + referral allocation, balanced ledger | §13.2–13.5 | NOT STARTED | F-2 |
...
| 15 | Verification scripts wired into checks | §4.4 | NOT STARTED | — |
