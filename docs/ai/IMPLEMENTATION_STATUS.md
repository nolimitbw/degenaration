...
| 2 | Authenticated Discord/KOL lifecycle | PARTIAL | APIs and UI exist; create/draft/activate/edit/version/pause/resume/archive/duplicate, cross-user denial, persisted hydration, and viewport evidence still require an authenticated test harness. |
