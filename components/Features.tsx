...
export default function Features() {
  return (
    <section id="features" className="mx-auto max-w-6xl px-5 py-24">
      ...
      >
        One terminal. <span className="cosmic-text">Every edge.</span>
      </motion.h2>
          ...
          <motion.div key={f.title}
            ...
            <Link href={f.href} className="card-cosmic group flex h-full flex-col p-7">
              <motion.span
                ...
                className="grid h-12 w-12 place-items-center rounded-xl bg-white/5 text-2xl ring-1 ring-white/10"
              >
                {f.icon}
              </motion.span>
